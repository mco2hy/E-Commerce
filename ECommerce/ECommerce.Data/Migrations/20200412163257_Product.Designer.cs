...
namespace ECommerce.Data.Migrations
{
    ...
    [Migration("20200412163257_Product")]
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.Title", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Active = true, CreateDate = new DateTime(2020, 4, 12, 16, 32, 57, 432, DateTimeKind.Utc), Deleted = false, Name = "Müşteri" },
                        new { Id = 2, Active = true, CreateDate = new DateTime(2020, 4, 12, 16, 32, 57, 432, DateTimeKind.Utc), Deleted = false, Name = "Yönetici" }
                    );
                });
            ...
            modelBuilder.Entity("ECommerce.Data.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Active = true, Admin = true, CreateDate = new DateTime(2020, 4, 12, 16, 32, 57, 432, DateTimeKind.Utc), Deleted = false, Email = "Admin@admin.com", EmailVerified = true, Name = "Admin", Password = "7C222FB2927D828AF22F592134E8932480637C0D", Surname = "Admin", TitleId = 2 }
                    );
                });
