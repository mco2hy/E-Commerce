var Account_ChangePassword = {
    ...
    Save: function () {
        ...
        if (newPassword != newPassword2) {
            ...
            Helper.UI.Alert("Hata!", "Mevcut şifreniz ile yeni şifre, aynı olamaz!", "error")
        }
        else if (newPassword.length < 8 || newPassword.length > 64) {
            Helper.UI.Alert("Hata!", "Yeni şifre, 8 karakterden kısa 64 karakterden uzun olmaz!", "error")
        }
        else if (password.length < 8 || password.length > 64) {
            Helper.UI.Alert("Hata!", "Şuan ki şifre, 8 karakterden kısa 64 karakterden uzun olmaz!", "error")
        } else {
